      ...
      >
        ...
        <div className="relative mb-4">
          <input
            ...
            required
            className="w-full p-4 text-sm border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500"
          />
        </div>
        ...
        <select
          ...
          value={formData.role}
          onChange={handleChange}
          className="w-full p-4 mb-4 text-sm border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500"
        >
